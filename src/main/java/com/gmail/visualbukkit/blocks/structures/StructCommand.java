...
@Description("Defines a new command that runs code when entered. To read arguments from this block, use the 'Argument' expression.")
public class StructCommand extends StructureBlock {
    ...
    public StructCommand() {
        ...
        initLine(" perm-fail-message: ", permissionMessage);
    }
