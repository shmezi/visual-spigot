...
public abstract class StatementBlock extends VBox implements CodeBlock, ElementInspector.Inspectable {
    ...
    protected Background normalBackground = new Background(new BackgroundFill(getDefinition().getBlockColor(), new CornerRadii(10, 10, 10, 10, false), Insets.EMPTY));
    protected Border normalBorder = new Border(new BorderStroke(getDefinition().getBlockColor().darker(), BorderStrokeStyle.SOLID, new CornerRadii(10, 10, 10, 10, false), BorderStroke.THIN));
    protected Background invalidatedBackground = new Background(new BackgroundFill(Color.RED, CornerRadii.EMPTY, Insets.EMPTY));
    /*protected Border highlightedBorder = new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(10, 10, 10, 10, false), new BorderWidths(2)), new BorderStroke(Color.YELLOW, BorderStrokeStyle.SOLID, new CornerRadii(10, 10, 10, 10, false), new BorderWidths(1)));*/
    protected Border highlightedBorder = new Border(new BorderStroke(Color.YELLOW, BorderStrokeStyle.SOLID, new CornerRadii(10, 10, 10, 10, false), BorderStroke.THIN));
    ...
    public StatementBlock() {
        ...
        syntaxBox.setStyle("-fx-font-family: Nunito;");
